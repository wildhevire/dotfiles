...
Rectangle {
  ...
  readonly property bool showNvidiaUsage: (widgetSettings.showNvidiaUsage !== undefined) ? widgetSettings.showNvidiaUsage : widgetMetadata.showNvidiaUsage
  readonly property bool showNvidiaTemp: (widgetSettings.showNvidiaTemp !== undefined) ? widgetSettings.showNvidiaTemp : widgetMetadata.showNvidiaTemp
  ...
  GridLayout {
    ...
    Item {
      ...
      GridLayout {
        ...
        NText {
          text: `${Math.round(SystemStatService.nvidiaPercent)}%`
          family: Settings.data.ui.fontFixed
          pointSize: textSize
          applyUiScale: false
          font.weight: Style.fontWeightMedium
    ...
    Item {
      ...
      GridLayout {
        ...
        NText {
          text: `${Math.round(SystemStatService.nvidiaTemp)}°`
          family: Settings.data.ui.fontFixed
          pointSize: textSize
          applyUiScale: false
          font.weight: Style.fontWeightMedium
